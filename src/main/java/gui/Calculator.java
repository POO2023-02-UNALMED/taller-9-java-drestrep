...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		String value = b.getText();
                ...
                if (number2.equals("f")){
                    if(!operadores.contains(value) && !value.equals("=")){
                        number1 = "";
                        number2 = "";
                    }
                    else{
                ...
                if(operadores.contains(value)){
                    if (operator == null || number2.equals("")){
                        ...
                        if (operator.equals("+")){
                           ...
                           if (Float.parseFloat(number2)*1 == 0){
                               divZero = true;
                           } else{
                              total = Float.parseFloat(number1) / Float.parseFloat(number2);  
                           }
                    ...
                    else if(operator == null || number2.equals("") || number2.equals("f")){
                        total = Float.parseFloat(number1);
                    }
                    else{
                        if (operator.equals("+")){
                           total = Float.parseFloat(number1) + Float.parseFloat(number2); 
                    ...
                    if (number1.equals("") || operator == null){
                        number1 += value;
                    }
                    else{
                        number2 += value;
                ...
                if (!number1.equals("")){
                    if (Float.parseFloat(number1)-(int)Float.parseFloat(number1) == 0 ){
                        number1 = ""+(int)Float.parseFloat(number1);
                    }
                }
                
                if (!number2.equals("")){
                    if (Float.parseFloat(number2)-(int)Float.parseFloat(number2) == 0 ){
                        number2 = ""+(int)Float.parseFloat(number2);
                    }
                }
                ...
                if (!divZero){
                    ...
                    displayText.setText("No se puede dividir por cero");
                }
                if (result){
                    number1 += "";
                    number2 += "f";
